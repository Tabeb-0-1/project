    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?php echo htmlentities(basename($_SERVER['REQUEST_URI']))=='about' ? 'active' : ''; ?>" href="/about"><?php echo Application::$app->language->dictionary['Lang_About']; ?></a>
                </li>
            </ul>
            <ul class="navbar-nav">
                <li class="nav-item">
...
<script src="<?php echo JS; ?>web3.min.js"></script>
